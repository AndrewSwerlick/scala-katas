...
organization := "swerlick.andrew.kata.roman"

version := "0.1.0-SNAPSHOT"

// description := "this project can foo a bar!"

homepage := Some(url("https://github.com/AndrewSwerlick/r2"))
...
scmInfo := Some(
  ScmInfo(
    url("https://github.com/AndrewSwerlick/r2"),
    "scm:git:https://github.com/AndrewSwerlick/r2.git",
    Some("scm:git:git@github.com:AndrewSwerlick/r2.git")
  )
)
...
/* entry point */
mainClass in (Compile, packageBin) := Some("swerlick.andrew.kata.roman.r2.Main")

mainClass in (Compile, run) := Some("swerlick.andrew.kata.roman.r2.Main")
...
/* assembly plugin */
mainClass in AssemblyKeys.assembly := Some("swerlick.andrew.kata.roman.r2.Main")
