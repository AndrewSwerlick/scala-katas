...
organization := "swerlick.andrew.katas.roman"

version := "0.1.0-SNAPSHOT"

// description := "this project can foo a bar!"

homepage := Some(url("https://github.com/AndrewSwerlick/r1"))
...
scmInfo := Some(
  ScmInfo(
    url("https://github.com/AndrewSwerlick/r1"),
    "scm:git:https://github.com/AndrewSwerlick/r1.git",
    Some("scm:git:git@github.com:AndrewSwerlick/r1.git")
  )
)
...
/* entry point */
mainClass in (Compile, packageBin) := Some("swerlick.andrew.katas.roman.r1.Main")

mainClass in (Compile, run) := Some("swerlick.andrew.katas.roman.r1.Main")
...
pomExtra := (
  <developers>
    <developer>
      <id>AndrewSwerlick</id>
      <name>Andrew Swerlick</name>
      <email>andrew.swerlick@gmail.com</email>
...
/* assembly plugin */
mainClass in AssemblyKeys.assembly := Some("swerlick.andrew.katas.roman.r1.Main")
