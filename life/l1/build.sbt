...
organization := "swerlick.andrew.kata.life"

version := "0.1.0-SNAPSHOT"

// description := "this project can foo a bar!"

homepage := Some(url("https://github.com/AndrewSwerlick/l1"))
...
scmInfo := Some(
  ScmInfo(
    url("https://github.com/AndrewSwerlick/l1"),
    "scm:git:https://github.com/AndrewSwerlick/l1.git",
    Some("scm:git:git@github.com:AndrewSwerlick/l1.git")
  )
)
...
/* entry point */
mainClass in (Compile, packageBin) := Some("swerlick.andrew.kata.life.l1.Main")

mainClass in (Compile, run) := Some("swerlick.andrew.kata.life.l1.Main")
...
/* assembly plugin */
mainClass in AssemblyKeys.assembly := Some("swerlick.andrew.kata.life.l1.Main")
